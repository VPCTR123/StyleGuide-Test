...
@Component({
    ...
    imports: [ CommonModule, SampleComponent, FormsModule, DocsComponent, NavComponent, SanitizeHtmlPipe, CardComponent, DrawerComponent, templateDrivenForms,FormsComponent,PopupComponent, MenuComponent,MenuItemComponent],
