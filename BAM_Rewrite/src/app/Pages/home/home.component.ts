...
{id:41, title:'CCA/FITREP/Eval Reports',description:'CCA/FITREP/Eval Reports',url:'https://www.bol.navy.mil/CCA',group:'',show:false,color:'#97a97c'},
...
{id:49, title:'Request Record on CD',description:'Request Record on CD',url:'https://www.bol.navy.mil/COMCD',group:'',show:false,color:'#97a97c'},
...
{id:67, title:'Selection Board Member/Recorder Training',description:'Selection Board Member/Recorder Training',url:'https://mpte.navy.deps.mil/sites/Solutions/SBTraining/SitePages/Home.aspx',group:'',show:false,color:'#97a97c'},
...
{id:84, title:'FLAG FITREPS',description:'FLAG FITREPS',url:'https://www.bol.navy.mil/FPARS/dashboard.aspx',group:'',show:false,color:'#97a97c'},
{id:87, title:'PRIMS',description:'PRIMS - NEW',url:'https://www.bol.navy.mil/PRIMS',group:'',show:false,color:'#97a97c'},
{id:90, title:'E-Submission',description:'ESUB',url:'https://www.bol.navy.mil/ESUB',group:'',show:false,color:'#97a97c'},
...
{id:114, title:'CO/XO/CMC Advancement/Selection Board Verification',description:'CO/XO/CMC Advancement/Selection Board Verification',url:'https://www.bol.navy.mil/boards/UICAccessList.aspx',group:'',show:false,color:'#97a97c'},
...
{id:253, title:'CWAY - Sailor Self-Service',description:'CWAY - Sailor Self-Service',url:'https://www.bol.navy.mil/cwaysailorselfservice/Landing/LandingPage.aspx',group:'',show:false,color:'#97a97c'},
{id:275, title:'ESSBD (Submit letter to SelBoard)',description:'Electronic Submssion to Selection Board',url:'https://nefp.bol.navy.mil/lc/apps/ws/index.html#/startprocess/ESSBD2%2FESSBD%20Letter%20to%20Board',group:'',show:false,color:'#97a97c'},
{id:280, title:'Officer Photo',description:'NAVPERS 1070/884',url:'https://nefp.bol.navy.mil/lc/apps/ws/index.html#/startprocess/NAVPERS%201070-884%2FNAVPERS%201070-884',group:'',show:false,color:'#97a97c'},
{id:285, title:'Name Change',description:'NAVPERS 1070/888',url:'https://nefp.bol.navy.mil/lc/apps/ws/index.html#/startprocess/eForms%2FNAVPERS%201070-888',group:'',show:false,color:'#97a97c'},
...
{id:320, title:'ERC',description:'Emprs Record Client (ERC)',url:'https://www.bol.navy.mil/ERC/',group:'',show:false,color:'#97a97c'},
{id:330, title:'eNavFit Program',description:'eNavFit',url:'https://nefp.bol.navy.mil/lc/ws',group:'',show:false,color:'#97a97c'},
{id:340, title:'NDAWS',description:'Navy Department of Awards Web Service',url:'https://nefp.bol.navy.mil/lc/ws',group:'',show:false,color:'#97a97c'}];
